...
Algo que seguro que has visto en muchos formularios es que, en función del valor de determinado campo, aparecen otros campos en el formulario. Por ejemplo, hay un selector para elegir la provincia y, cuando seleccionamos una provincia, se muestra otro selector con todos los municipios de la provincia y, al elegir un municipio, se muestran las poblaciones del mismo.
