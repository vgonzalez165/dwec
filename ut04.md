...
Vamos a seguir mejorando la aplicación, aunque ahora de una forma menos dirigida. El objetivo será añadir un botón junto al botón de *eliminar* para marcar una tarea como *hecha*.
