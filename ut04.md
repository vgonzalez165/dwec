...
Añade un script a la página que puedes encontrar [aquí](assets/pr0403/pr0403.html) que muestre la siguiente información en los elementos `<div>` el final:
...
Seguimos trabajando con la página anterior, pero ya puedes quitar el botón ya que lo que queremos ahora es que, cuando hagas click sobre una imagen se elimine del DOM.

Algunos consejos para realizar esta práctica:

- Cada imagen deberá tener un *listener* que se activará cuando el usuario haga click sobre ella.
